...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"> Online Auction Report</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        </div><!-- /.col -->
      </div><!-- /.row -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Online Auction Result Data</h3>

              <div class="card-tools">
                <div class="input-group input-group-sm" style="width: 150px;">
                  <div class="input-group-append">
                    <a href="print.php" target="blank_"class="btn btn-primary"><i class="fas fa-print"></i>Print Report</a>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <?php } else { ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <?php } else { ?>
                            <div class="btn btn-success btn-sm">Auction Completed</div>
                          <?php } ?>  
                        </td>
                      </tr>
                    <?php } ?>
